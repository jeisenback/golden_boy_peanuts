...
from tools.agents.issue_refinement.issue_refinement_agent import refine_issue
from tools.agents.issue_refinement.models import IssueMetadata
...
def format_comment(result: IssueRefinementResult) -> str:  # type: ignore[name-defined]  # noqa: F821
    ...
    return (
        ...
        f"[source](tools/agents/issue_refinement/)*"
    )
